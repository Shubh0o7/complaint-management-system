...
<body class="campus-auth-page">
    <main class="campus-auth-shell">
        <header class="campus-auth-nav"><a class="campus-auth-brand" href="index.php"><span class="campus-auth-mark"><i class="bi bi-shield-check"></i></span><span><strong>CampusResolve</strong><small>Student Grievance Portal</small></span></a><nav><a href="index.php">Home</a><a href="docs/README.md">Our platform</a><a href="docs/WORKFLOWS-AND-DASHBOARDS.md">About us</a><a href="mailto:support@campusresolve.example">Contact us</a></nav><a class="campus-auth-nav-cta" href="register.php">Sign up</a></header>
